        ...
        <div class="table-responsive">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-start">
                            <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6"><?php echo get_the_title($post->ID); ?></a>
                        </td>
                        ...
                        <td class="text-start">
                        <button type="submit" form="form-delete_category-27" class="btn btn-xs btn-icon btn-light btn-active-light-danger toggle h-25px w-25px">
