								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="d-flex align-items-center justify-content-between gap-10">
										...
										<form class="position-relative" autocomplete="off">
											...
											<!--end::Icon-->
											<!--begin::Input-->
											<input type="text" class="form-control form-control-lg form-control-solid px-15" name="search" value="" placeholder="Search Tournaments" data-kt-search-element="input">
											<!--end::Input-->															
										</form>
										<!--begin::Form-->
										<!--begin::Primary button-->
										<a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Add Tournament</a>
										<!--end::Primary button-->
									</div>
									<!--end::Actions-->
								</div>
											...
											<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url(<?php echo BORAHH_ADL_TOURNAMENTS_DIR_MEDIA . 'patterns/vector-1.png'; ?>)">
												...
												<div class="card-body d-flex flex-column justify-content-end pe-0">
													...
													<div class="w-50 d-flex flex-stack">
														<!--begin::Section-->
														<a href="#" class="text-light fw-semibold fs-6 me-2">Manage</a>
														<!--end::Section-->
