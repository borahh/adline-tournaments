                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-row justify-content-center flex-wrap me-3">
                                    ...
                                    <!--end::Svg Icon-->
                                    <!--begin::Title-->
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-1 flex-column justify-content-center my-0">Update Category</h1>
                                    <!--end::Title-->
                                        ...
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            ...
                                            <form id="form-update_category" class="form" method="POST" action="admin.php?page=actions.php" autocomplete="off">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <!--begin::Input-->
                                                    <input type="text" name="update_term" class="form-control form-control-solid mb-5 mb-lg-0 p-3 border border-gray-500" placeholder="e.g., Bow Hunting" value="<?php echo $term->name;?>" required />
                                                    <!--end::Input-->
                                                    ...
                                                    <!--begin::Input-->
                                                    <input type="text" name="update_slug" class="form-control form-control-solid mb-5 mb-lg-0 p-3 border border-gray-500" placeholder="e.g., bow-hunting" value="<?php echo $term->slug;?>" required />
