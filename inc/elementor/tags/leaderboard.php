...
class Elementor_Dynamic_Leaderboard extends \Elementor\Core\DynamicTags\Data_Tag {
	...
	public function get_value( array $options = array() ) {
        $value = 'leaderboard/' . get_queried_object()->post_name;
        return $value;
	}
